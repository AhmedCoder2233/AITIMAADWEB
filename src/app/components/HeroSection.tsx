  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        {/* Green gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary-500/20 via-primary-400/10 to-white" />
      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        >
          Pakistan's First Trusted
          <span className="block mt-2 text-primary-600">Review Platform</span>
        </motion.h1>
        ...
        >
          Discover honest reviews from real people. Share your experience and help others make informed decisions.
        </motion.p>
      </div>
    </motion.section>
  );
