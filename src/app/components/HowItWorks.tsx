...
export default function HowItWorksSection() {
  ...
  const customerSteps = [
    ...
    },
    {
      ...
      description: "Provide proof of purchase and submit your review for businesses"
    }
  ];
  ...
  const businessSteps = [
    ...
    },
    {
      ...
      title: "Get Reviews In Your Website",
      description: "Get all reviews of your business displayed in your own website using our widget"
    }
  ];
        ...
        <ScrollAnimationWrapper direction="up">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              How AITI<span className="text-[#15803D]">MAAD</span> Works
            </h2>
                  ...
                  <div className="text-gray-700 space-y-3">
                    {activeTab === 'customer' ? (
                      <>
                        ...
                        <p className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-[#15803D] flex-shrink-0 mt-0.5" />
                          <span>Only verified customers can submit reviews businesses</span>
                        </p>
                        <p className="flex items-start gap-2">
                          <CheckCircle className="w-5 h-5 text-[#15803D] flex-shrink-0 mt-0.5" />
