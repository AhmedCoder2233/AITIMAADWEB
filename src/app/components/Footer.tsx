...
import { Shield, Facebook, Twitter, Instagram, Linkedin, Mail, Phone, Home } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-900 overflow-hidden text-white pt-12 pb-8">
            ...
            <ScrollAnimationWrapper direction="up" amount={0.2}>
              <div className="flex items-center space-x-2 mb-6">
                ...
                <h2 className="text-2xl font-bold">
                  AITI<span style={{ color: greenColor }}>MAAD</span>
                </h2>
              </div>
            ...
            <ScrollAnimationWrapper direction="up" delay={0.5} amount={0.2}>
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-gray-400">
                  ...
                  <span>info@aitimaad.com</span>
                </div>
                <div className="flex items-center text-gray-400">
                  <Phone className="h-5 w-5 mr-3" />
                  <span>+92 332 2705270</span>
                </div>
                <div className="flex items-center text-gray-400">
                  <Home className="h-5 w-5 mr-3" />
                  <span>Head Office: 1C Lane 7th Zamzama Commercial Phase V DHA</span>
                </div>
              </div>
            </ScrollAnimationWrapper>
        ...
        <ScrollAnimationWrapper direction="up" delay={0.8} amount={0.2}>
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">
              © 2026 AITIMAAD. All rights reserved.
            </p>
