...
import { Menu, X, User, Building, LogOut, ChevronDown, Home, Users, MessageSquare, Phone, Package, Info, StarIcon, Settings, MessageCircle } from 'lucide-react';
...
export default function Header() {
  ...
  const navItems = [
    ...
    { href: '/getmorereviews', label: 'Get More Reviews', icon: StarIcon },
  ];
          ...
          <nav className="hidden md:flex items-center space-x-0.5 lg:space-x-2">
            ...
            {profile?.user_type === 'business' && (
              <>
                ...
                {/* Widget Usage in Main Nav - Only for Business Users */}
                <Link
                  href="/widgetusage"
                  className="relative px-2 py-1.5 lg:px-4 lg:py-2 text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors duration-200 group"
                >
                  <span className={`relative z-10 flex items-center gap-1.5 lg:gap-2 ${
                    ...
                    <MessageCircle className={`${isMediumScreen ? 'h-3.5 w-3.5' : 'h-4 w-4'}`} />
                    <span className={isMediumScreen ? 'truncate max-w-[70px]' : ''}>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            {user ? (
              ...
              <div className="hidden md:block relative">
                ...
                {/* Profile Dropdown with Settings and Widget Usage */}
                <AnimatePresence>
                  {isProfileMenuOpen && (
                    <motion.div
                    ...
                    >
                      ...
                      <div className="p-2 space-y-1">
                        ...
                        <Link href="/settings" onClick={() => setIsProfileMenuOpen(false)}>
                          <div className="flex items-center gap-3 px-3 py-2.5 hover:bg-blue-50 text-gray-700 w-full text-left transition-all rounded-lg group">
                            <div className="h-8 w-8 flex items-center justify-center bg-blue-100 rounded-lg group-hover:bg-blue-200 transition-colors">
                        ...
                        {profile?.user_type === 'business' && (
                          <>
                            ...
                            {/* Widget Usage Link */}
                            <Link href="/widgetusage" onClick={() => setIsProfileMenuOpen(false)}>
                              <div className="flex items-center gap-3 px-3 py-2.5 hover:bg-purple-50 text-gray-700 w-full text-left transition-all rounded-lg group">
                                <div className="h-8 w-8 flex items-center justify-center bg-purple-100 rounded-lg group-hover:bg-purple-200 transition-colors">
                        ...
                        <button
                          ...
                          className="flex items-center gap-3 px-3 py-2.5 hover:bg-red-50 text-red-600 w-full text-left transition-all rounded-lg group mt-1"
                        >
            ...
            >
              <div className="py-4 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  {/* Business-specific Links in Mobile Menu */}
                  {profile?.user_type === 'business' && (
                    <>
                      <Link
                        href="/pricing"
