...
interface AuthContextType {
  ...
  signUp: (email: string, password: string, fullName: string, userType: UserType, phoneNumber?: string, businessDetails?: Partial<Profile>, profilePicture?: File) => Promise<{success: boolean, message: string}>;
...
const signUp = async (
  ...
  try {
    ...
    console.log('✅ Auth user created (needs verification):', userId);
    ...
    const profileData: any = {
      ...
      full_name: fullName,
      user_type: userType,
      profile_url: profileUrl || null, // ✅ ALWAYS include this field, either URL or null
    };
    ...
    console.log('✅ Profile URL in database:', profileResponse?.profile_url);
