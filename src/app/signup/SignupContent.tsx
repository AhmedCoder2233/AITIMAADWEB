...
import { User, Building, Mail, Lock, Eye, EyeOff, UserPlus, AlertCircle, Upload, X, Camera, Edit, CheckCircle } from 'lucide-react';
...
export default function SignupContent() {
  ...
  businessDetails,  // ✅ 6th parameter: businessDetails
  profilePicture || undefined, // ✅ 7th parameter: profilePicture
  captchaToken, // ✅ 8th parameter: captchaToken
);
      if (result.success) {
        setError('');
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
                ...
                >
                  <div className="text-center">
                    ...
                    <button
                      onClick={() => router.push(`/login?type=${userType}&registered=true`)}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      ...
                      <p className="text-xs text-gray-500 mt-2 text-center">
                        Please verify that you're not a robot to complete your registration
                      </p>
                    </div>
